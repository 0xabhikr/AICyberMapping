...
export default function Googledorking() {
  ...
  return (
    <div className="min-h-screen flex justify-center items-center px-4 ">
      <Card className="w-250 h-100 mr-[20]">
  <CardHeader>
  ...
  <CardFooter>
    <p>Card Footer</p>
      ...
      <div className="w-full max-w-md p-6 bg-white dark:bg-gray-900 rounded-xl shadow-lg border border-black/20 dark:border-white/20">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="rounded-lg px-6 py-3 mx-auto block backdrop-blur-2xl bg-black/10 dark:bg-white/20 
    ...
    text-black dark:text-white transition hover:scale-105"
        ...
        {response && (
          <div className="mt-4 p-3 bg-gray-200 dark:bg-gray-800 rounded text-black dark:text-white">
            Response: {response}
          </div>
        )}
      </div>
